...
function getIconName(href) {
  const lower = href.toLowerCase();
  return Object.keys(ICONS).find((key) => lower.includes(key)) || null;
}
...
export default function decorate(block) {
  ...
  if (firstRow) {
    ...
    if (thirdRow) {
      ...
      if (socialCol) {
        // support both <a> hyperlinks and plain text URLs
